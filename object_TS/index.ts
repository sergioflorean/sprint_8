...
// Define el tipo GeoCoords aquí

type GeoCoords = [lat: number, long: number];

// Define una interfaz llamada WeatherStation que describa la estructura completa del objeto (utilizando GeoCoords para las coordenadas).
